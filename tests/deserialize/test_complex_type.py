...
class Amount(halogen.types.Type):
    ...
    def deserialize(cls, value):
        ...
        return dict(amount=amount, currency=value["currency"])
...
class NestedSchema(halogen.Schema):
    ...
    products = halogen.Attr(
        halogen.types.List(Product, allow_scalar=True, validators=[halogen.validators.Length(min_length=0)]),
        default=[],
    )
...
def test_nested():
    ...
    nested_data = {
        "person": {"name": "Johann", "surname": "Gambolputty"},
        "is_friend": True,
...
@pytest.mark.parametrize(
    ...
    [
        (
            {"is_friend": True, "price": {"currency": "EUR", "amount": "wrong_amount"}},
            {
                "attr": "<root>",
                "errors": [
                    {"errors": [{"type": "str", "error": "Missing attribute."}], "attr": "person"},
                    {"attr": "price", "errors": [{"type": "ValueError", "error": "Invalid decimal for amount."}]},
                ],
            },
        ),
        (
            {"person": "", "is_friend": True, "price": {"currency": "EUR", "amount": "wrong_amount"}},
            {
                "attr": "<root>",
                "errors": [
                    {
                        "errors": [
                            {"errors": [{"type": "str", "error": "Missing attribute."}], "attr": "name"},
                            {"errors": [{"type": "str", "error": "Missing attribute."}], "attr": "surname"},
                        ],
                        "attr": "person",
                    },
                    {"attr": "price", "errors": [{"type": "ValueError", "error": "Invalid decimal for amount."}]},
        ...
        (
            ...
            },
            {
                ...
                "errors": [
                    {
                        "errors": [{"errors": [{"type": "str", "error": "Missing attribute."}], "attr": "surname"}],
                        "attr": "person",
                    },
                    {"attr": "price", "errors": [{"type": "ValueError", "error": "Invalid decimal for amount."}]},
                ],
        ...
        (
            {
                "person": {"name": "Some name", "surname": "Some surname"},
                "is_friend": True,
                "price": {"currency": "EUR", "amount": "12.23"},
                "products": [{"name": "Some name"}, {"name": "Some name", "quantity": 1}],
            },
            {
                "errors": [
                    {
                        "errors": [
                            {
                                "errors": [
                                    {"errors": [{"type": "str", "error": "Missing attribute."}], "attr": "quantity"}
                                ],
                                "index": 0,
                            }
                        ],
